...
function MakePremiumScriptHub()
    ...
    OrionLib:MakeNotification({
        Name = "Correct Key!",
        Content = "You Have Entered A Correct Key! (Premium)",
        Image = "rbxassetid://4483345998",
        Time = 5
    })
...
if game.PlaceId == 606849621 then
        ...
        --Window
        local Window = OrionLib:MakeWindow({Name = "GameHub - Orion - Jailbreak", HidePremium = false, IntroEnabled = false, IntroText = "Game Hub", SaveConfig = true, ConfigFolder = "GameHub-Orion"})
        ...
        local MainJailbreakTab = Window:MakeTab({
            Name = "Main",
            Icon = "rbxassetid://4483345998",
            PremiumOnly = false
        })
        ...
        local ScriptsJailbreakTab = Window:MakeTab({
            Name = "Scripts",
            Icon = "rbxassetid://4483345998",
            PremiumOnly = false
        })
        ...
        local PlayerJailbreakTab = Window:MakeTab({
            Name = "Player",
            Icon = "rbxassetid://4483345998",
            PremiumOnly = false
        })
        ...
        local OtherJailbreakTab = Window:MakeTab({
            Name = "Other",
            Icon = "rbxassetid://4483345998",
            PremiumOnly = false
        })
        ...
        local MiscJailbreakTab = Window:MakeTab({
            Name = "Misc",
            Icon = "rbxassetid://4483345998",
            PremiumOnly = false
        })
        ...
        PlayerJailbreakTab:AddSlider({
            ...
            ValueName = "WS",
            Callback = function(Value)
                game:GetService('Players').LocalPlayer.Character.Humanoida.WalkSpeed = Value
            end    
        })
